...
- 이 사업은 교육사업인가?
- 교육용역, 교육운영, 훈련, 강의, 인재양성, 아카데미가 핵심 과업인가?
- 콘텐츠 개발사업인가?
- LMS, 플랫폼, 시스템 구축처럼 개발·SI로 분류될 과업이 포함되어 있는가?
- 역량평가 또는 직무진단 사업인가?
- 보안진단 또는 보안컨설팅 사업인가?
- 보안교육, 개발보안, 시큐어코딩, 보안인식 제고가 핵심 과업인가?
- 단순 SI, 장비납품, 유지보수, 행사대행 사업인가?
- 개발외주, SI 개발, 시스템 구축, 데이터 구축, 플랫폼 구축이 핵심 과업인가?
...
- 클라우드, 보안, AI 교육이 핵심 과업이다.
- 공고명 또는 과업에 교육용역, 교육운영, 훈련, 강의, 인재양성, 아카데미가 명확히 포함되어 있다.
- 장기 교육과정 운영이 포함되어 있다.
...
- 개발보안 교육, 보안인식 제고, 개인정보보호 교육, 정보보호 교육이 포함되어 있다.
- 보안이 부수 키워드가 아니라 사업의 핵심 목적이다.
...
- 개발외주, SI 개발, 시스템 통합, 업무시스템 구축이 핵심이다.
- LMS, 교육 플랫폼, 훈련 시스템, 역량평가 시스템 구축이 핵심이다.
- 앱 개발, 웹 개발, 포털 구축, 플랫폼 구축이 핵심이다.
- 장비 납품이나 물품 구매가 중심이다.
- 홈페이지, ERP, 그룹웨어 등 일반 SI 구축사업이다.
- 유지보수, 운영대행, 사무행정이 중심이다.
- 지원 용역, 생태계 활성화, 민관협력, 협의체 운영, 사업 운영지원처럼 과업이 포괄적이고 교육·보안이 명확하지 않다.
- 홍보, 행사, 영상, 디자인 중심이다.
...
- "AI", "데이터", "플랫폼" 키워드가 있어도 교육·보안·개발보안·보안인식 제고와 연결되지 않는 개발용역이다.
- 공공데이터 구축, 데이터 개방, 데이터 분석모델 개발이 핵심이고 교육·보안 목적이 없다.
...
| 평가항목 | 배점 | 설명 |
|---|---:|---|
| 사업 적합도 | 30 | 교육용역, 보안교육, 개발보안, 보안인식 제고 등 오픈이지 핵심 사업과 얼마나 직접적으로 연결되는가. 개발·SI 과업은 감점한다. |
| 매출 가능성 | 20 | 교육운영, 교육콘텐츠, 보안교육, 개발보안 교육, 평가 등 매출 규모와 반복 가능성이 있는가 |
| 수주 가능성 | 20 | 교육운영 실적, 보안교육 실적, 강사풀, 커리큘럼, 콘텐츠 역량으로 실제 수주 가능성이 있는가 |
| 전략적 가치 | 15 | 후속사업, 레퍼런스, 시장확장 가치가 있는가 |
| 수행 리스크 | 15 | 수행 부담, 상주, 개발·SI 과업, 인력 리스크가 낮은가 |
...
- 27~30점: 교육용역이 핵심이거나 ICT 교육·보안교육·개발보안·시큐어코딩·보안인식 제고가 핵심이다. 예: 클라우드·보안·AI·개발 장기교육, KDT, 정보보호 인재양성, 개발보안 교육, 보안인식 제고 교육
- 22~26점: 교육, 콘텐츠, 평가, 교육 플랫폼, 보안진단·보안컨설팅 중 하나와 명확히 관련 있다.
- 16~21점: 일부 관련은 있으나 핵심 과업은 아니다.
- 8~15점: 키워드는 있으나 실제 사업 적합도는 낮다. 교육이 부수적이거나 보안이 형식적 요구사항에 가깝다.
- 0~7점: 오픈이지 사업과 거의 무관하다. 일반 SI 개발, 개발외주, 장비납품, 시스템 구축, 데이터 구축, 플랫폼 구축은 이 구간을 기본값으로 한다.

매출 가능성:

- 18~20점: 장기 교육운영, 과정설계, 콘텐츠개발, 보안교육, 개발보안 교육, 평가 등이 결합되어 매출 규모가 크다.
- 14~17점: 교육운영, 교육콘텐츠 개발, 보안인식 제고, 개발보안 교육 중심으로 일정 매출이 기대된다.
- 9~13점: 단기 교육, 특강, 소규모 용역 수준이다.
- 4~8점: 매출 가능성은 있으나 규모가 작거나 일회성이다. 순수 보안진단만 있는 경우도 교육 결합이 없으면 이 구간 또는 중간 구간으로 신중히 본다.
- 0~3점: 오픈이지 기준 매출화 가능성이 낮다. SI 개발, 개발외주, 시스템 구축, 데이터 구축, 플랫폼 구축 매출은 오픈이지의 매출 기회로 보지 않는다.

수주 가능성:

- 18~20점: 기존 IT 교육용역, 보안교육, 개발보안/시큐어코딩 교육, 인재양성 사업과 매우 유사하며 강점이 명확하다.
- 14~17점: 교육 또는 보안교육 수행 가능성이 높고 경쟁력도 있다.
- 9~13점: 수행은 가능하나 경쟁이 강하거나 추가 파트너가 필요하다.
- 4~8점: 일부 수행 가능하지만 제약이 많다. 개발외주, SI, 시스템 구축, 데이터 구축 과업은 기본적으로 이 구간 이하로 본다.
- 0~3점: 수주 가능성이 매우 낮다. 대형 SI, 단순 개발, 데이터 구축, 장비 중심 공고가 여기에 해당한다.
...
- 3~5점: 수행 부담이 크다. 상주 개발, SI 통합, 시스템 구축, 데이터 구축, 대규모 산출물 중심이면 이 구간을 기본으로 한다.
- 0~2점: 수행 리스크가 매우 높다. 교육·보안과 무관한 개발외주, 시스템 구축 또는 대형 SI는 이 구간을 고려한다.

### 4.3 강제 보정 규칙

아래 규칙은 세부 점수 산정 후 최종 점수를 보정할 때 반드시 적용한다.

- 교육용역이 핵심이면 특별한 리스크가 없는 한 `business_fit`을 24점 이상으로 둔다.
- 교육용역이면서 보안, 개발보안, 시큐어코딩, 보안인식 제고 중 하나가 핵심이면 `business_fit`을 27점 이상으로 둔다.
- 보안과 관련이 아주 깊은 사업은 교육이 없더라도 낮게 평가하지 않는다. 단, 순수 진단/컨설팅이면 교육 결합 공고보다 두 단계 낮게 둔다.
- 개발보안, 시큐어코딩, 보안인식 제고는 오픈이지의 강한 전문영역으로 보며 높은 가점을 준다.
- SI 개발, 개발외주, 시스템 통합, 업무시스템 구축이 포함되어 있으면 최종 점수에서 최소 25점을 차감한다.
- SI 개발, 개발외주, 시스템 통합, 업무시스템 구축이 핵심이면 최종 등급은 반드시 `D`로 둔다.
- 데이터 구축, 데이터 개방, 데이터 분석모델 개발, 플랫폼 구축, 앱·웹 개발, 포털 구축이 포함되어 있으면 최종 점수에서 최소 20점을 차감한다.
- 데이터 구축, 데이터 개방, 데이터 분석모델 개발, 플랫폼 구축, 앱·웹 개발, 포털 구축이 핵심이면 최종 등급은 반드시 `D` 이하로 둔다.
- 교육·보안·개발보안·보안인식 제고와 무관한 개발용역은 예산이 커도 반드시 `D`로 판단한다.
- "AI", "데이터", "플랫폼" 키워드가 있어도 실제 과업이 데이터 구축 또는 시스템 개발이면 교육용역으로 오인하지 않는다.
- 공공데이터 구축·개방, 데이터셋 구축, 데이터 분석모델 개발은 교육·보안·개발보안·보안인식 제고가 핵심 목적이 아니면 최종 등급을 원칙적으로 `C` 이하로 둔다.
- 데이터 구축·개방 공고는 예산이 크더라도 오픈이지의 핵심 매출모델인 IT 교육용역으로 보지 않는다.
- LMS, 교육 플랫폼, 코딩 실습환경, 시큐어코딩 훈련 시스템처럼 보이는 항목도 "구축"이 핵심이면 개발·SI 과업으로 보고 감점한다.
- 교육운영, 강의, 과정개발, 보안교육이 명확한 핵심 과업이 아닌 경우에는 개발·SI 감점을 상쇄하지 않는다.
- "지원 용역", "생태계 활성화", "민관협력", "협의체 운영", "운영지원"처럼 포괄적인 일반 용역은 교육운영, 보안교육, 개발보안, 시큐어코딩, 보안인식 제고가 공고명 또는 본문에 명확히 없으면 최종 등급을 반드시 `C` 이하로 둔다.
- 교육·보안이 명확하지 않은 일반 지원/활성화/운영 용역은 예산 규모, 공공성, 후속 가능성만으로 `A` 또는 `S`를 줄 수 없다.
- 본문과 첨부파일이 없는 상태에서 "교육 가능성", "워크숍 가능성", "컨설팅 가능성"만으로 점수를 올리지 않는다.
